...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Excerpt from hypothesis generation}
...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Excerpt from testing hypothesis}
...
\begin{table}[H]
		\begin{center}
			...
			\end{tabular}
		\end{center}
	\caption{Excerpt from a new hypothesis}
...
Siri then starts to formulate a hypothesis for why the plant in the closet is growing more than the one in the window. Basically what she is saying is that heliotropism makes the plant in the window grow slower because it has to move after the sun, and since the plant in the closet can grow straight up without following the sun, it can grow faster. By saying this, it seems as if she is mixing the concepts of germination and photosynthesis.%but what is germination?
This can be explained by the textbook not saying anything about germination. 

\subsection{Scaffolding to fix misconception}

\subsubsection*{Context}
In table~\ref{excerpt:teachertalk} the teacher has been talking with the group for a couple of minutes and Siri has talked about her hypothesis that the plant in the closet might have got more than just green light, and if it only got green light it would probably not grow that much.
...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Excerpt from misconception not followed}
...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Excerpt from teacher intervention}
...
\begin{table}[H]
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Excerpt from usage of scientific language}
...
\begin{table}[H]
	\begin{adjustwidth}{-4em}{-4em}
		...
		\end{center}
	\end{adjustwidth}
	\caption{Excerpt from linking representations}
