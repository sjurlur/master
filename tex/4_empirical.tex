...
When we selected the group of students that were to be filmed, we employed the strategy of "purpousful sampling" \citep{baxter1997evaluating}. Together with the teacher we found a selection of students that were able to express their thoughts and discuss freely. They also seemed relatively unaffected by our presence and the presence of cameras. Prior to the selection we also made sure that none of the students would feel uncomfortable being filmed. This helped us get an information rich case with many different experiences to answer our research questions. 

During our contact with the high school, we were present at numerous occasions. This helped us get a more complete picture of the dynamics of the biology class in question. So while our main corpus of data is a one hour video, our analysis is informed by a more complete picture of the situation. During these visits we made observation notes that is also included in our data material. This is a strategy called triangulation of methods \citep{baxter1997evaluating}, which implies the notion that different methods can mutually support one another. 

During data collection we were at all times two researchers observing the same phenomenon. This helped us create "thicker" accounts of the same phenomena, and discuss the events among ourselves. We also included our supervisor in screening of the video data to get more perspectives on the same data material. Variations in interpretations of the events unfolding was also discussed.
...
While we will make no claim about the transferability of our study, we have tried to provide as thick descriptions \citep{geertz1973interpretation} as possible. We have also included our data material in the appendices so the reader herself can determine the degree of transferability of our results. 
