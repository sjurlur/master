...
\section{Scaffolding}
During the inquiry process there were several occasions where the students needed extra guidance to keep on the path towards the goal. In this section we will discuss these events and delve into the question: \emph{how is scaffolding instantiated in the environment?}.

In an open learning environment the students are 
