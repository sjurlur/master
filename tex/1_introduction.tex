...
\begin{figure}
	\centering
	\includegraphics[width=0.7\textwidth]{img/introduction/graphlapse.png}
...
This will naturally adreess the characteristics of the students' actions \& interactions during their work with Monoplant. The first question will also be elaborated through the next three questions.
...
\subsubsection*{Chapter 3 - Technical architecture \& programming}
